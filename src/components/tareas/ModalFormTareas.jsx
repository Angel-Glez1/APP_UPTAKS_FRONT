...
const ModalFormularioTarea = () => {
    ...
    const { handleModalTareas, modalFormularioTareas, newError, alerta, saveTarea, tarea } = useProyectos();
    const [nombre, setNombre] = useState('');
    const [descripcion, setDescripcion] = useState('');
    const [prioridad, setPreoridad] = useState('');
    ...
    const handleSubmit = async (e) => {
        ...
        await saveTarea({ id, nombre, descripcion, prioridad, fechaEntrega, proyecto: params.id })
    ...
    return (
        <Transition.Root show={modalFormularioTareas} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalTareas}>
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form className='my-10' onSubmit={handleSubmit}>
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            <select
                                                onChange={(e) => setPreoridad(e.target.value)}
                                                id="prioridad"
                                                className='border-2 w-full p-2 mt-2 placeholder-gray-50 rounded-sm outline-none '
                                                value={prioridad}
                                            >
